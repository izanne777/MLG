...
torch.manual_seed(8310)       
torch.cuda.manual_seed_all(8310)
...
def evaluate(data, X, Y, model, evaluateL2, evaluateL1, batch_size, test):
    model.eval()
    total_loss = 0
    total_loss_l1 = 0
    n_samples = 0
...
parser.add_argument('--conv_kernel', type=int, nargs='+',default=[12, 16],help='MIC-block multi-scale size')
parser.add_argument('--hid_size', type=int, default=3, help='SCI-block hidden size')
...
def main():
    ...
    model = gtnet(args.gcn_true, args.buildA_true, args.gcn_depth, args.num_nodes,
                  ...
                  conv_kernel = args.conv_kernel, hid_size=args.hid_size )
